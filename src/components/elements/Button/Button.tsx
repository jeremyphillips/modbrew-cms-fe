...
const Button = ({
  ...
  const coreClassNames =
    'flex gap-1 rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-opacity-50 items-center disabled:opacity-50'

  const sizeClassNames = size === 'sm' ? 'px-2 py-1' : size === 'lg' ? 'px-8 py-4' : 'px-6 py-3'
